class Slider {
  constructor() {
    ...
    this.images = [
      ...
      'https://images.pexels.com/photos/20796500/pexels-photo-20796500.jpeg',
      'https://images.pexels.com/photos/20819059/pexels-photo-20819059.jpeg',
      'https://images.pexels.com/photos/20819264/pexels-photo-20819264.jpeg'  
  ...
  transitionNext() {
    ...
    const currentImages2 = current.querySelectorAll('.items');
    const nextImages2 = next.querySelectorAll('.items');

    const currentImages3 = current.querySelectorAll('.carousel');
    const nextImages3 = next.querySelectorAll('.carousel');
    ...
    tl.
      ...
      staggerFromTo(currentImages2, 1.5, {
        yPercent: 0,
        scale: 1
      },
        {
        ...
        staggerFromTo(currentImages3, 1.5, {
          yPercent: 0,
          scale: 1
        },
          {
